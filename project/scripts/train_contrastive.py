...
def main() -> None:
    ...
    train_cfg = ContrastiveTrainConfig(
        ...
        temperature_trainable=bool(cfg.train.temperature_trainable),
        temperature_min=float(cfg.train.temperature_min),
        temperature_max=float(cfg.train.temperature_max),
